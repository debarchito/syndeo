            ...
            <div class="mb-6 flex items-center gap-3">
              ...
              <div>
                <h2 class="text-lg font-bold md:text-xl">
                  Welcome back, {data.teacher?.displayName || data.teacher?.name}!
                </h2>
              ...
              <Card.Root class="shadow-sm">
                <Card.Content class="p-4">
                  ...
                  <Button
                    variant="outline"
                    class="w-full"
                    onclick={() => goto("/teacher/dashboard/appointments")}
                  >
                ...
                <Card.Content class="p-4">
                  <div class="mb-3 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p class="text-muted-foreground text-xs">Chat with students</p>
                    </div>
                  </div>
                  <Button
                    variant="outline"
                    class="w-full"
                    onclick={() => goto("/teacher/dashboard/message/list")}
                  >
